  ...
  const deleteAccount = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/auth/${userId}/delete-account`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${userData.token}`,
    ...
    <div className=" max-w-[40rem] mx-auto ">
      ...
      <div className=" mt-[3rem] ">
        <div
          ...
          className=" bg-[#fc1f44] cursor-pointer border-2 border-[#fc1f44] text-[#fff] hover:bg-[#fff] hover:border-[#fff] transition-colors duration-300 ease-in-out w-full py-2 rounded-md text-center mt-[1rem] "
        >
          Delete Account
        </div>
      </div>
